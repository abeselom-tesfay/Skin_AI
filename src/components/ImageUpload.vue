<template>
  <div class="flex flex-col items-center gap-4 w-full max-w-md mx-auto pt-20 px-4 md:px-20">
    <h1 class="text-2xl font-bold text-gray-900">Skin Image Upload & Analysis</h1>
    ...
    <button 
      ...
      class="bg-blue-900 text-white px-6 py-2 rounded disabled:opacity-50 flex items-center justify-center gap-2"
    >
