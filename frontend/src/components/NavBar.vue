<template>
  <nav class="fixed w-full top-0 left-0 z-50 bg-cyan-700 px-4 md:px-20 py-3 flex justify-between items-center">
    ...
    <ul class="hidden md:flex space-x-6 text-white font-medium">
      ...
      <li><a href="/#tech-stack" class="hover:text-blue-500 transition-colors underline">Technical Details</a></li>
    ...
    >
      <a href="/#main" class="hover:text-cyan-500 underline" @click="isOpen = false">Main</a>
      <a href="/#tech-stack" class="hover:text-blue-500 transition-colors underline" @click="isOpen = false">Technical Details</a>
