<template>
  <section class="px-4 md:px-20 py-20 flex justify-center items-center">
    <div class="w-full max-w-2xl bg-white p-10 md:p-16 rounded-lg shadow-lg">
      <h1 class="text-4xl font-semibold text-center mb-6">Register</h1>
